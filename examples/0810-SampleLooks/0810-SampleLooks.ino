/*
    ...
    Equinox(tm) - 0810-B - 19 Pixel Demo Modes and Patterns
    This item is compatible with WS2812B and NeoPixel code

    Available on Tindie at: https://www.tindie.com/products/16428/
...
// Change this to be the pin on your Arduino you use to connect to Data.
#define PIN 7

// Panel 0810 has 19 LEDs on it.
#define N_LEDS 19
